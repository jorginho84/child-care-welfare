...
alpha_opt = opt.x[0]
gamma_opt = opt.x[1]
meanshocks_opt = opt.x[2]
covshock_00_opt = opt.x[3]
covshock_01_opt = opt.x[4]
covshock_11_opt = opt.x[5]
betas0_opt = opt.x[6]
betas1_opt = opt.x[7]
sigma2w_opt = opt.x[8]
betastd_opt = opt.x[9]
...
betas_opt = np.array([alpha_opt,gamma_opt,meanshocks_opt,covshock_00_opt,
                      covshock_01_opt,covshock_11_opt,betas0_opt,
